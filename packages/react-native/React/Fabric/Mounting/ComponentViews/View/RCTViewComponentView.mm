...
- (void)_safeAreaInsetsMayHaveChanged
{
  ...
  // Only a change of the insets triggers an event: a view that moves without
  // its overlap with the system UI changing stays silent, which is what makes
  // observing views safe to place inside scroll views.
