 ...
 *
 * @generated SignedSource<<ae33e08038c9cee41956fa75a8ecbb95>>
 */
...
class ReactNativeFeatureFlagsJavaProvider
 ...
 public:
  ...
  bool enableImageTransparentTintColor() override {
    static const auto method =
        getReactNativeFeatureFlagsProviderJavaClass()->getMethod<jboolean()>("enableImageTransparentTintColor");
    return method(javaProvider_);
  }
  ...
  bool enablePerSurfaceTextScaleAndroid() override {
    static const auto method =
        getReactNativeFeatureFlagsProviderJavaClass()->getMethod<jboolean()>("enablePerSurfaceTextScaleAndroid");
    return method(javaProvider_);
  }
...
bool JReactNativeFeatureFlagsCxxInterop::enableImageTransparentTintColor(
    facebook::jni::alias_ref<JReactNativeFeatureFlagsCxxInterop> /*unused*/) {
...
bool JReactNativeFeatureFlagsCxxInterop::enablePerSurfaceTextScaleAndroid(
    facebook::jni::alias_ref<JReactNativeFeatureFlagsCxxInterop> /*unused*/) {
  return ReactNativeFeatureFlags::enablePerSurfaceTextScaleAndroid();
}
...
void JReactNativeFeatureFlagsCxxInterop::registerNatives() {
  javaClassLocal()->registerNatives({
      ...
      makeNativeMethod(
        ...
        JReactNativeFeatureFlagsCxxInterop::enableImageTransparentTintColor),
      makeNativeMethod(
      ...
      makeNativeMethod(
        ...
        JReactNativeFeatureFlagsCxxInterop::enablePerSurfaceTextScaleAndroid),
      makeNativeMethod(
