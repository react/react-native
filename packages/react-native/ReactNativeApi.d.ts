 ...
 *
 * @generated SignedSource<<ee943fbc35a18c2b05c55c12b5e9efc5>>
 *
...
declare type ____ViewStyle_InternalBase = {
  ...
  readonly maskImage?: ReadonlyArray<BackgroundImageValue> | string
  readonly maskPosition?: ReadonlyArray<BackgroundPositionValue> | string
  readonly maskRepeat?: ReadonlyArray<BackgroundRepeatValue> | string
  readonly maskSize?: ReadonlyArray<BackgroundSizeValue> | string
...
declare type BackgroundImageValue =
...
declare type URLBackgroundImageValue = {
  type: "url"
  uri: number | string
}
...
export {
  ...
  ActivityIndicator, // 78820c15
  ActivityIndicatorInstance, // a82dd4e7
  ActivityIndicatorProps, // ded6942c
  Alert, // a398a509
  ...
  DrawerLayoutAndroid, // 8efe0702
  DrawerLayoutAndroidInstance, // c0694352
  DrawerLayoutAndroidProps, // 1034e28f
  ...
  FlatList, // c0840ab3
  FlatListInstance, // c3b70ff5
  FlatListProps, // f95eb3a9
  FocusEvent, // 850f1517
  ...
  Image, // 7666419f
  ImageBackground, // 5311e4e6
  ImageBackgroundInstance, // 8c498b53
  ImageBackgroundProps, // 2d7febd7
  ...
  InputAccessoryView, // 045c7220
  InputAccessoryViewProps, // 1b8359f0
  ...
  KeyUpEvent, // 57f832c5
  Keyboard, // 49414c97
  KeyboardAvoidingView, // d5a54bde
  KeyboardAvoidingViewInstance, // 475d4243
  KeyboardAvoidingViewProps, // d3d1f3bd
  ...
  RefreshControl, // 76a4295f
  RefreshControlInstance, // f6f9eac4
  RefreshControlProps, // 3028e0a2
  ...
  RootViewStyleProvider, // 7e8587e0
  Runnable, // 594dd93a
  Runnables, // 4367c557
  SafeAreaView, // eed995bb
  SafeAreaViewInstance, // 21dba39c
  ScaledSize, // 07e417c7
  ScrollEvent, // d7abdd0a
  ScrollResponderType, // c6236c7a
  ScrollToLocationParamsType, // d7ecdad1
  ScrollView, // 08d27833
  ScrollViewImperativeMethods, // 3f896bcd
  ScrollViewInstance, // 85906dc5
  ScrollViewProps, // ec0ca824
  ScrollViewPropsAndroid, // 02f3df2e
  ScrollViewPropsIOS, // 807cb4f6
  ScrollViewScrollToOptions, // 3313411e
  SectionBase, // 9f13db00
  SectionList, // ae79ae22
  SectionListData, // 1a4de01a
  SectionListInstance, // 9eb7aad3
  SectionListProps, // c1c257d6
  ...
  TouchableHighlight, // 04adf802
  TouchableHighlightInstance, // b510c0eb
  TouchableHighlightProps, // 8ade4662
  TouchableNativeFeedback, // 66953b88
  TouchableNativeFeedbackInstance, // 9c598e5a
  TouchableNativeFeedbackProps, // ab63f091
  TouchableOpacity, // 7f73b8f3
  TouchableOpacityInstance, // b186055b
  TouchableOpacityProps, // 3eb2de50
  TouchableWithoutFeedback, // acd854bf
  TouchableWithoutFeedbackProps, // d14f0c38
