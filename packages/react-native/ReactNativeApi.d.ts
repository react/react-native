 ...
 *
 * @generated SignedSource<<739253e7b90afea5959c264e1ac3d91a>>
 *
...
declare type ____FontVariationSettings_Internal =
  | string
  | {
...
declare type ____TextStyle_InternalBase = {
  ...
  readonly fontVariationSettings?: ____FontVariationSettings_Internal
  ...
  readonly textDecorationLine?:
    "line-through" | "none" | "underline line-through" | "underline"
...
declare type ____ViewStyle_InternalBase = {
  ...
  readonly backgroundPosition?: ReadonlyArray<BackgroundPositionValue> | string
  readonly backgroundRepeat?: ReadonlyArray<BackgroundRepeatValue> | string
  readonly backgroundSize?: ReadonlyArray<BackgroundSizeValue> | string
...
declare type AccessibilityActionName =
  "activate" | "decrement" | "escape" | "increment" | "longpress" | "magicTap"
...
declare interface AccessibilityProps extends Readonly<
...
> {
  ...
  readonly "aria-valuemax"?: AccessibilityValue["max"]
  readonly "aria-valuemin"?: AccessibilityValue["min"]
  readonly "aria-valuenow"?: AccessibilityValue["now"]
  readonly "aria-valuetext"?: AccessibilityValue["text"]
  readonly role?: Role
}
...
declare interface ActivityIndicatorProps extends Readonly<
  ViewProps & ActivityIndicatorIOSProps
> {
...
declare class Alert {
  ...
  static prompt(
    ...
    message?: null | string | undefined,
    callbackOrButtons?:
      (((text: string) => void) | AlertButtons) | null | undefined,
...
declare type AlertType =
  "default" | "login-password" | "plain-text" | "secure-text"
...
declare class AnimatedTracking_default extends AnimatedNode_default {
  constructor(
    ...
    parent: AnimatedNode_default,
    animationClass: new (...args: any[]) => Animation_default,
...
declare type BackgroundPositionValue =
  | {
...
declare type BackgroundRepeatKeyword =
  "no-repeat" | "repeat" | "round" | "space"
declare type BackgroundRepeatValue = {
  x: BackgroundRepeatKeyword
  y: BackgroundRepeatKeyword
}
declare type BackgroundSizeValue = {
  x: number | string
  y: number | string
}
...
declare interface FlatListProps<ItemT> extends Readonly<
  Omit<
...
>
declare interface ImageProps extends Readonly<
  ImagePropsIOS & ImagePropsAndroid & Omit<ImagePropsBase, "style">
> {
  readonly style?: ImageStyleProp
}
...
declare type ImageResizeMode =
  "center" | "contain" | "cover" | "none" | "repeat" | "stretch"
...
declare interface ImageStyle extends ____ImageStyle_Internal {}
...
declare type InputValue =
  (ColorValue | RgbaAnimatedValue | RgbaValue) | null | undefined
...
declare type InterpolationConfigSupportedOutputType =
  NativeColorValue | number | string
...
declare type KeyboardEventEasing =
  "easeIn" | "easeInEaseOut" | "easeOut" | "keyboard" | "linear"
...
declare type KeyDownEvent = NativeSyntheticEvent<KeyEvent>
...
declare type KeyEventProps = {
  ...
  readonly onKeyDownCapture?: (event: KeyDownEvent) => void
  readonly onKeyUp?: (event: KeyUpEvent) => void
  readonly onKeyUpCapture?: (event: KeyUpEvent) => void
}
declare function keyExtractor(item: any, index: number): string
declare type KeysOfUnion<T> = T extends any ? keyof T : never
declare type KeyUpEvent = NativeSyntheticEvent<KeyEvent>
...
declare type LayoutAnimationProperty =
  "opacity" | "scaleX" | "scaleXY" | "scaleY"
declare type LayoutAnimationType =
  "easeIn" | "easeInEaseOut" | "easeOut" | "keyboard" | "linear" | "spring"
...
declare type LooseOmit<O extends {}, K extends number | string | symbol> = Pick<
  O,
  Exclude<keyof O, K>
>
...
declare type PlatformType =
  AndroidPlatform | IOSPlatform | MacOSPlatform | WebPlatform | WindowsPlatform
...
declare type PressableBaseProps = {
  ...
  readonly cancelable?: boolean
  readonly children?:
    ((state: PressableStateCallbackType) => React.ReactNode) | React.ReactNode
  readonly delayHoverIn?: number
  readonly delayHoverOut?: number
  readonly delayLongPress?: number
  readonly disabled?: boolean
  ...
  readonly style?:
    ((state: PressableStateCallbackType) => ViewStyleProp) | ViewStyleProp
  readonly testID?: string
  readonly testOnly_pressed?: boolean
}
declare type PressableInstance = HostInstance
declare interface PressableProps extends Readonly<
  Omit<ViewProps, "onMouseEnter" | "onMouseLeave"> & PressableBaseProps
> {}
declare interface PressableStateCallbackType {
...
declare type RootViewStyleProvider = (
...
declare interface SectionListProps<
  ItemT,
  SectionT = DefaultSectionT,
> extends Readonly<
  Omit<
...
declare interface Spec_2 extends TurboModule {
  ...
  ) => undefined | ViewManagerConfig
  readonly getDefaultEventTypes?: () => ViewManagerConfig
  readonly lazilyLoadView?: (name: string) => ViewManagerConfig
...
declare type StatusBarProps = Readonly<StatusBarPropsIOS & StatusBarBaseProps>
...
declare type StyleProp<T> =
  "" | false | null | ReadonlyArray<StyleProp<T>> | T | void
...
declare type TextInputIOSProps = {
  ...
  readonly dataDetectorTypes?:
    (DataDetectorTypesType | undefined) | ReadonlyArray<DataDetectorTypesType>
...
>
declare interface TextInputProps extends Readonly<
  Omit<ViewProps, "style"> &
    TextInputIOSProps &
...
declare interface TextProps extends Readonly<
...
declare interface TextStyle extends ____TextStyle_Internal {}
...
declare interface TouchableWithoutFeedbackProps extends Readonly<
...
declare type TrackingAnimationConfig = Readonly<
  AnimationConfig & {
    toValue: AnimatedNode_default
  }
>
...
declare type UIManagerConstants = UnsafeObject
...
declare type URIRequestBody = {
  readonly base64?: string
  readonly blob?: BlobData
  readonly formData?: Array<FormDataPart>
...
declare type ViewManagerConfig = UnsafeObject
declare interface ViewProps extends Readonly<
  DirectEventProps &
...
declare interface ViewStyle extends ____ViewStyle_Internal {}
...
export {
  ...
  ActivityIndicator, // 7bb76795
  ActivityIndicatorInstance, // a82dd4e7
  ActivityIndicatorProps, // e3c81e37
  Alert, // a398a509
  ...
  DrawerLayoutAndroid, // 10f3ab23
  DrawerLayoutAndroidInstance, // aa243cbf
  DrawerLayoutAndroidProps, // 8144971b
  ...
  FlatList, // ce8451f1
  FlatListInstance, // 9e0c1443
  FlatListProps, // 19fa3c9e
  FocusEvent, // 850f1517
  FontVariant, // 7c7558bb
  GestureResponderEvent, // 14d3e77a
  GestureResponderHandlers, // b540de80
  HostComponent, // a611806a
  HostInstance, // f78dcaf8
  I18nManager, // f9870e00
  IEventEmitter, // fbef6131
  IOSKeyboardEvent, // e67bfe3a
  IgnorePattern, // ec6f6ece
  Image, // 70beaf51
  ImageBackground, // 125f114f
  ImageBackgroundInstance, // b32a44b1
  ImageBackgroundProps, // 58c484ed
  ...
  InputAccessoryView, // 69da97d8
  InputAccessoryViewProps, // 6c4ba417
  ...
  KeyUpEvent, // 57f832c5
  Keyboard, // 49414c97
  KeyboardAvoidingView, // 86ce3237
  KeyboardAvoidingViewInstance, // 39e5e0cb
  KeyboardAvoidingViewProps, // 5ea2df10
  ...
  PressableProps, // 573ac60a
  PressableStateCallbackType, // 5e0cfa78
  ProcessedColorValue, // 33f74304
  ProgressBarAndroid, // db8f6a6b
  ...
  TouchableHighlightProps, // 08cd59e1
  TouchableNativeFeedback, // e2791ad5
  TouchableNativeFeedbackInstance, // ce1ad7e9
  TouchableNativeFeedbackProps, // ffc9c1d4
  TouchableOpacity, // c62caed3
  TouchableOpacityInstance, // b186055b
  TouchableOpacityProps, // d3c970ad
  TouchableWithoutFeedback, // da544b16
  TouchableWithoutFeedbackProps, // a14626e7
