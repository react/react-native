 ...
 *
 * @generated SignedSource<<f149315f8e37312fb4dd209e9bc094cf>>
 *
...
declare type ____TextStyle_InternalCore = Readonly<
  ViewStyle & ____TextStyle_InternalBase
>
...
declare interface ButtonProps extends Readonly<{
  accessibilityActions?: ReadonlyArray<AccessibilityActionInfo>
  accessibilityHint?: string
  accessibilityLabel?: string
...
declare interface ImageStyle extends Readonly<
...
declare interface InputAccessoryViewProps extends Readonly<{
...
declare interface ModalBaseProps extends Omit<
  {
...
declare class NodeList_default<T> implements Iterable<T>, ArrayLike_2<T> {
  [index: number]: T
  readonly length: number
  entries(): IteratorObject<[number, T]>
  forEach<ThisType>(
    callbackFn: (
      value: T,
      index: number,
...
> {}
declare interface PressableStateCallbackType extends Readonly<{
  pressed: boolean
}> {}
...
declare interface TextStyle extends Readonly<
...
declare interface ViewStyle extends Readonly<
...
export {
  AccessibilityActionEvent, // ca0e86fd
  AccessibilityActionInfo, // db47a917
  AccessibilityInfo, // d92c5eae
  AccessibilityProps, // 38fadc29
  ...
  ActivityIndicator, // 394b7931
  ActivityIndicatorInstance, // 1b5e0dd5
  ActivityIndicatorProps, // a29b65e4
  Alert, // a398a509
  ...
  Button, // ae3a5c1a
  ButtonInstance, // ca9f9f2c
  ButtonProps, // 39e96945
  Clipboard, // 41addb89
  ...
  DrawerLayoutAndroid, // bb1f117c
  DrawerLayoutAndroidInstance, // aa243cbf
  DrawerLayoutAndroidProps, // 6dfbb780
  ...
  FlatList, // e2cbd439
  FlatListInstance, // d303d390
  FlatListProps, // 127de274
  FocusEvent, // f2e4363d
  FontVariant, // 7c7558bb
  GestureResponderEvent, // 5cd2a663
  GestureResponderHandlers, // c67c25e0
  HostComponent, // 22c9ea3d
  HostInstance, // 17bb0a55
  I18nManager, // f9870e00
  IEventEmitter, // fbef6131
  IOSKeyboardEvent, // e67bfe3a
  IgnorePattern, // ec6f6ece
  Image, // 5f2594c5
  ImageBackground, // 8e6cd53d
  ImageBackgroundInstance, // ea910a10
  ImageBackgroundProps, // 83540ab3
  ...
  InputAccessoryView, // f4ef0505
  InputAccessoryViewProps, // 30a87786
  ...
  KeyUpEvent, // 0b5d0144
  Keyboard, // 49414c97
  KeyboardAvoidingView, // 26496c43
  KeyboardAvoidingViewInstance, // 8e4c4b92
  KeyboardAvoidingViewProps, // 6a467ebe
  ...
  RefreshControl, // 4a304ec4
  RefreshControlInstance, // d4e341ce
  RefreshControlProps, // fb5fbb1a
  RefreshControlPropsAndroid, // 8ac931ca
  RefreshControlPropsIOS, // 72a36381
  Registry, // 6c39216d
  ResponderSyntheticEvent, // f5da3211
  ...
  TextInputContentSizeChangeEvent, // 1fe0e260
  TextInputEndEditingEvent, // 7aa9093a
  TextInputFocusEvent, // ef604040
  TextInputIOSProps, // fb3c9327
  TextInputInstance, // 53fe7b73
  TextInputKeyPressEvent, // cbbc322a
  TextInputProps, // 61a33d47
  ...
  TouchableHighlight, // e3556d20
  TouchableHighlightInstance, // 811af7ca
  TouchableHighlightProps, // d486cd8f
  TouchableNativeFeedback, // ecf7c029
  TouchableNativeFeedbackInstance, // 1075430b
  TouchableNativeFeedbackProps, // 2a848169
  TouchableOpacity, // 24977ca1
  TouchableOpacityInstance, // 0cd8a347
  TouchableOpacityProps, // b3029644
  TouchableWithoutFeedback, // 7a253c2a
  TouchableWithoutFeedbackProps, // 2ed52c8c
  ...
  requireNativeComponent, // da1880ff
