 ...
 *
 * @generated SignedSource<<204b70c0b7e57b7dcbcaf0a5a95f0bfd>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableIOSCompressedTextFrameAdjustment() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(24, "enableIOSCompressedTextFrameAdjustment");
...
bool ReactNativeFeatureFlagsAccessor::enableIOSTextBaselineOffsetPerLine() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(25, "enableIOSTextBaselineOffsetPerLine");
...
bool ReactNativeFeatureFlagsAccessor::enableIOSViewClipToPaddingBox() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(26, "enableIOSViewClipToPaddingBox");
...
bool ReactNativeFeatureFlagsAccessor::enableImagePrefetchingAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(27, "enableImagePrefetchingAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableImageTransparentTintColor() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(28, "enableImageTransparentTintColor");
...
bool ReactNativeFeatureFlagsAccessor::enablePerSurfaceTextScaleAndroid() {
  auto flagValue = enablePerSurfaceTextScaleAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(40, "enablePerSurfaceTextScaleAndroid");

    flagValue = currentProvider_->enablePerSurfaceTextScaleAndroid();
    enablePerSurfaceTextScaleAndroid_ = flagValue;
  }
