 ...
 *
 * @generated SignedSource<<8e0ff0b8215e5f617b56cd0578824f8a>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableAliasedTextRoleInheritance() {
  auto flagValue = enableAliasedTextRoleInheritance_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(12, "enableAliasedTextRoleInheritance");

    flagValue = currentProvider_->enableAliasedTextRoleInheritance();
    enableAliasedTextRoleInheritance_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::enableImageTransparentTintColor() {
  auto flagValue = enableImageTransparentTintColor_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(29, "enableImageTransparentTintColor");
...
bool ReactNativeFeatureFlagsAccessor::enableIntersectionObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(33, "enableIntersectionObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::enableMountingCoordinatorPullModelAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(38, "enableMountingCoordinatorPullModelAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableMutationObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(39, "enableMutationObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::enableResizeObserverByDefault() {
  auto flagValue = enableResizeObserverByDefault_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(43, "enableResizeObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::enableRuntimeSchedulerQueueClearingOnError() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(44, "enableRuntimeSchedulerQueueClearingOnError");
...
bool ReactNativeFeatureFlagsAccessor::enableSchedulerDelegateInvalidation() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(45, "enableSchedulerDelegateInvalidation");
