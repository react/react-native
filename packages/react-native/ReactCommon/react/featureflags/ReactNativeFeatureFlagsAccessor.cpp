 ...
 *
 * @generated SignedSource<<afdc7a70babe5016fa9c2cab5cb4b4a7>>
 */
...
bool ReactNativeFeatureFlagsAccessor::disableIdleTimersFrameCallbackRearmAndroid() {
  auto flagValue = disableIdleTimersFrameCallbackRearmAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(5, "disableIdleTimersFrameCallbackRearmAndroid");

    flagValue = currentProvider_->disableIdleTimersFrameCallbackRearmAndroid();
    disableIdleTimersFrameCallbackRearmAndroid_ = flagValue;
  }
