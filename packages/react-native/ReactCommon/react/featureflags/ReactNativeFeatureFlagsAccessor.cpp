 ...
 *
 * @generated SignedSource<<17b868eae3608867568378490113eff6>>
 */
...
bool ReactNativeFeatureFlagsAccessor::disableIdleNativeAnimatedFrameCallbackRearmAndroid() {
  auto flagValue = disableIdleNativeAnimatedFrameCallbackRearmAndroid_.load();
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(5, "disableIdleNativeAnimatedFrameCallbackRearmAndroid");

    flagValue = currentProvider_->disableIdleNativeAnimatedFrameCallbackRearmAndroid();
    disableIdleNativeAnimatedFrameCallbackRearmAndroid_ = flagValue;
  }
...
bool ReactNativeFeatureFlagsAccessor::enableMountingCoordinatorPullModelAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(39, "enableMountingCoordinatorPullModelAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableMutationObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(40, "enableMutationObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::enableResizeObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(44, "enableResizeObserverByDefault");
