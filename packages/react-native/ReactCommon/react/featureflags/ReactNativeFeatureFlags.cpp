 ...
 *
 * @generated SignedSource<<d05965cfcfa0b9543aed461833b9a1cc>>
 */
...
bool ReactNativeFeatureFlags::enableAliasedTextRoleInheritance() {
  return getAccessor().enableAliasedTextRoleInheritance();
}
