 ...
 *
 * @generated SignedSource<<74a45aeaddf2211aeefebd5beff2f4ff>>
 */
...
class ReactNativeFeatureFlagsDynamicProvider : public ReactNativeFeatureFlagsDefaults {
 ...
 public:
  ...
  bool disableIdleNativeAnimatedFrameCallbackRearmAndroid() override {
    auto value = values_["disableIdleNativeAnimatedFrameCallbackRearmAndroid"];
    if (!value.isNull()) {
      return value.getBool();
    }

    return ReactNativeFeatureFlagsDefaults::disableIdleNativeAnimatedFrameCallbackRearmAndroid();
  }
  ...
  bool enableImageTransparentTintColor() override {
    auto value = values_["enableImageTransparentTintColor"];
    if (!value.isNull()) {
      return value.getBool();
    }

    return ReactNativeFeatureFlagsDefaults::enableImageTransparentTintColor();
  }
