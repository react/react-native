...
public class SampleTurboModule(private val context: ReactApplicationContext) :
  ...
  override fun initialize() {
    ...
    permissionLauncher =
        context.registerForActivityResult(
            ...
            { exception: RuntimeException ->
              pendingPermissionPromise?.reject("E_ACTIVITY_RESULT_LAUNCH_FAILED", exception)
              pendingPermissionPromise = null
            },
        )
    ...
    pickMediaLauncher =
        context.registerForActivityResult(
            ...
            { exception: RuntimeException ->
              pendingPickMediaPromise?.reject("E_ACTIVITY_RESULT_LAUNCH_FAILED", exception)
              pendingPickMediaPromise = null
            },
        )
    ...
    pickMultipleMediaLauncher =
        context.registerForActivityResult(
            ...
            { exception: RuntimeException ->
              pendingPickMultipleMediaPromise?.reject("E_ACTIVITY_RESULT_LAUNCH_FAILED", exception)
              pendingPickMultipleMediaPromise = null
            },
        )
  }
  ...
  override fun startSecondActivity() {
    ...
    val intent =
        Intent(Intent.ACTION_VIEW, "rntester://example/PhotoPickerAndroid".toUri())
  ...
  override fun invalidate() {
    ...
    if (::pickMediaLauncher.isInitialized) {
      pickMediaLauncher.unregister()
    }
    if (::pickMultipleMediaLauncher.isInitialized) {
