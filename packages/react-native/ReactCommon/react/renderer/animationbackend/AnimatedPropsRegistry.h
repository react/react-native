...
struct SurfaceContext {
  ...
  std::unordered_set<std::shared_ptr<const ShadowNodeFamily>> pendingFamilies,
      families;
};
  ...
  switch (propName) {
    ...
    case MARGIN:
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Left, snapshot.props.yogaStyle.margin(yoga::Edge::Left));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Right,
          snapshot.props.yogaStyle.margin(yoga::Edge::Right));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Top, snapshot.props.yogaStyle.margin(yoga::Edge::Top));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Bottom,
          snapshot.props.yogaStyle.margin(yoga::Edge::Bottom));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Start,
          snapshot.props.yogaStyle.margin(yoga::Edge::Start));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::End, snapshot.props.yogaStyle.margin(yoga::Edge::End));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Horizontal,
          snapshot.props.yogaStyle.margin(yoga::Edge::Horizontal));
      viewProps.yogaStyle.setMargin(
          yoga::Edge::Vertical,
          snapshot.props.yogaStyle.margin(yoga::Edge::Vertical));
      break;

    case PADDING:
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Left, snapshot.props.yogaStyle.padding(yoga::Edge::Left));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Right,
          snapshot.props.yogaStyle.padding(yoga::Edge::Right));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Top, snapshot.props.yogaStyle.padding(yoga::Edge::Top));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Bottom,
          snapshot.props.yogaStyle.padding(yoga::Edge::Bottom));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Start,
          snapshot.props.yogaStyle.padding(yoga::Edge::Start));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::End, snapshot.props.yogaStyle.padding(yoga::Edge::End));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Horizontal,
          snapshot.props.yogaStyle.padding(yoga::Edge::Horizontal));
      viewProps.yogaStyle.setPadding(
          yoga::Edge::Vertical,
          snapshot.props.yogaStyle.padding(yoga::Edge::Vertical));
      break;

    case POSITION:
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Left,
          snapshot.props.yogaStyle.position(yoga::Edge::Left));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Right,
          snapshot.props.yogaStyle.position(yoga::Edge::Right));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Top, snapshot.props.yogaStyle.position(yoga::Edge::Top));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Bottom,
          snapshot.props.yogaStyle.position(yoga::Edge::Bottom));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Start,
          snapshot.props.yogaStyle.position(yoga::Edge::Start));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::End, snapshot.props.yogaStyle.position(yoga::Edge::End));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Horizontal,
          snapshot.props.yogaStyle.position(yoga::Edge::Horizontal));
      viewProps.yogaStyle.setPosition(
          yoga::Edge::Vertical,
          snapshot.props.yogaStyle.position(yoga::Edge::Vertical));
      break;

    case BORDER_WIDTH:
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Left, snapshot.props.yogaStyle.border(yoga::Edge::Left));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Right,
          snapshot.props.yogaStyle.border(yoga::Edge::Right));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Top, snapshot.props.yogaStyle.border(yoga::Edge::Top));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Bottom,
          snapshot.props.yogaStyle.border(yoga::Edge::Bottom));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Start,
          snapshot.props.yogaStyle.border(yoga::Edge::Start));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::End, snapshot.props.yogaStyle.border(yoga::Edge::End));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Horizontal,
          snapshot.props.yogaStyle.border(yoga::Edge::Horizontal));
      viewProps.yogaStyle.setBorder(
          yoga::Edge::Vertical,
          snapshot.props.yogaStyle.border(yoga::Edge::Vertical));
      break;
    ...
    case ALIGN_CONTENT:
      viewProps.yogaStyle.setAlignContent(
          snapshot.props.yogaStyle.alignContent());
      break;
    ...
    case ASPECT_RATIO:
      viewProps.yogaStyle.setAspectRatio(
          snapshot.props.yogaStyle.aspectRatio());
      break;
    ...
    case FLEX_DIRECTION:
      viewProps.yogaStyle.setFlexDirection(
          snapshot.props.yogaStyle.flexDirection());
      break;

    case ROW_GAP:
      viewProps.yogaStyle.setGap(
          yoga::Gutter::Row, snapshot.props.yogaStyle.gap(yoga::Gutter::Row));
      break;

    case COLUMN_GAP:
      viewProps.yogaStyle.setGap(
          yoga::Gutter::Column,
          snapshot.props.yogaStyle.gap(yoga::Gutter::Column));
      break;
    ...
    case JUSTIFY_CONTENT:
      viewProps.yogaStyle.setJustifyContent(
          snapshot.props.yogaStyle.justifyContent());
      break;

    case MAX_HEIGHT:
      viewProps.yogaStyle.setMaxDimension(
          yoga::Dimension::Height,
          snapshot.props.yogaStyle.maxDimension(yoga::Dimension::Height));
      break;

    case MAX_WIDTH:
      viewProps.yogaStyle.setMaxDimension(
          yoga::Dimension::Width,
          snapshot.props.yogaStyle.maxDimension(yoga::Dimension::Width));
      break;

    case MIN_HEIGHT:
      viewProps.yogaStyle.setMinDimension(
          yoga::Dimension::Height,
          snapshot.props.yogaStyle.minDimension(yoga::Dimension::Height));
      break;

    case MIN_WIDTH:
      viewProps.yogaStyle.setMinDimension(
          yoga::Dimension::Width,
          snapshot.props.yogaStyle.minDimension(yoga::Dimension::Width));
      break;
    ...
    case POSITION_TYPE:
      viewProps.yogaStyle.setPositionType(
          snapshot.props.yogaStyle.positionType());
      break;
