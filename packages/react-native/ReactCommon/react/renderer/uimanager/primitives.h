...
inline static std::shared_ptr<std::vector<std::shared_ptr<const ShadowNode>>>
shadowNodeListFromValue(jsi::Runtime& runtime, const jsi::Value& value) {
...
inline static std::shared_ptr<std::vector<std::shared_ptr<const ShadowNode>>>
shadowNodeListFromWeakList(
    const std::shared_ptr<std::vector<std::weak_ptr<const ShadowNode>>>&
        weakShadowNodeList) {
  auto result =
      std::make_shared<std::vector<std::shared_ptr<const ShadowNode>>>();
...
inline static std::shared_ptr<std::vector<std::weak_ptr<const ShadowNode>>>
weakShadowNodeListFromValue(jsi::Runtime& runtime, const jsi::Value& value) {
